...
function help() 
{
    ...
    echo "    -b                  Build opration, working with -d,-p,-c. "            
    echo "    -e                  Expand operation, working with -d,-p,-c. "
    echo "    build               Build operation."
    echo "    expand              Expand operation."
    echo "    -v                  Version info. "
    echo "    -h                  Help."
    echo "Example:"
    ...
    echo "    bash generate_installation_packages.sh -b -d "
    echo "    bash generate_installation_packages.sh -b -c " 
    echo "    bash generate_installation_packages.sh -e -p ../../fisco-bcos "
    echo "    bash generate_installation_packages.sh -e -d "
    echo "    bash generate_installation_packages.sh -e -c " 
    exit 0
}
