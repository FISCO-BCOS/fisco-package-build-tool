...
比如：weth_host_0=("172.20.245.42" "0.0.0.0" "2" "1" "0" "0" "d4f2ba36f0434c0a8c1d01b9df1c2bce" "agent_0") 是第一台服务器上面的配置, 说明需要在172.20.245.42这台服务器上面启动两个节点。
...
```
  ...
  ```sh
  $ ./node_manager.sh registerNode /root/172.20.245.42_with_0.0.0.0_genesis_installation_package/node_action_info_dir/nodeactioninfo_172_20_245_42_0.json
    ===================================================================
    node.json=file:/root/172.20.245.42_with_0.0.0.0_genesis_installation_package/node_action_info_dir/nodeactioninfo_172_20_245_42_0.json
    NodeIdsLength= 1
    ----------node 0---------
