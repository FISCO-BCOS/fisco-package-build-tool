...
下面以172.20.245.42_with_172.20.245.42_genesis_installation_package包为例说明目录结构, 其他安装包的目录结构完全一致：
```shell
...
ext/cert
        agent0
                node_172.20.245.42_0/node.crt
                node_172.20.245.42_1/node.crt
        agent1
                node_172.20.245.43_0/node.crt
                node_172.20.245.43_1/node.crt
        agent2
                node_172.20.245.44_0/node.crt
                node_172.20.245.44_1/node.crt
